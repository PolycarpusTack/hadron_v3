...
import { Eye, Trash2, Star, Languages } from "lucide-react";
...
export const AnalysisListItem = memo(function AnalysisListItem({
  ...
  return (
    <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4 hover:border-gray-600 transition">
...
export const TranslationListItem = memo(function TranslationListItem({
  ...
  return (
    <div className="bg-gray-800/50 border border-blue-700/30 rounded-lg p-4 hover:border-blue-600/50 transition">
      <div className="flex items-start justify-between gap-4">
